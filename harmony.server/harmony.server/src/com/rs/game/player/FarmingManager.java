...
public class FarmingManager implements Serializable {
	...
	private static final int REGENERATION_CONSTANT = Settings.DEBUG ? 5000 : 120000; // Twelve
	// minutes
	private static final int ALLOTMENT = 0, TREES = 1, HOPS = 2, FLOWERS = 3, FRUIT_TREES = 4, BUSHES = 5, HERBS = 6,
			COMPOST = 7, RAKE = 5341, EMPTY_BUCKET = 1925;

	private static final String[] PATCH_NAMES = { "allotment", "tree", "hops", "flower", "fruit tree", "bush", "herb" };
	...
	public boolean isAlwaysWeeded = false;
	...
	public static enum ProductInfo {
		 ...
		 * Allotments
		 */
		Potato(5318, 1, 1942, 0, 8, 90, 10, new Item(6032, 2), ALLOTMENT), Onion(5319, 5, 1957, 1, 9.5, 100.5, 10,
				new Item(5438, 1), ALLOTMENT), Cabbage(5324, 7, 1965, 2, 10, 110.5, 10, new Item(5458, 1),
						ALLOTMENT), Tomato(5322, 12, 1982, 3, 12.5, 140, 10, new Item(5478, 2), ALLOTMENT), Sweetcorn(
								5320, 20, 5986, 4, 17, 190, 10, 6, new Item(5931, 10), ALLOTMENT), Strawberry(5323, 31,
										5504, 5, 26, 290, 10, 6, 2, new Item(5386, 1), ALLOTMENT), Watermelon(5321, 47,
												5982, 6, 48.5, 540.5, 10, 8, 4, new Item(5970, 10), ALLOTMENT),

		/**
		 * Herbs
		 */
		Guam(5291, 9, 199, 0, 11, 12.5, 20, HERBS), Marrentill(5292, 14, 201, 1, 13.5, 15, 20, HERBS), Tarromin(5293, 19, 203, 2, 16, 18, 20, HERBS), Harralander(5294, 26, 205, 3, 21.5, 24, 20, HERBS), Rannar(5295, 32, 207, 4, 27, 30.5, 20, HERBS), Toadflax(5296, 38, 3049, 5, 34, 38.5, 20, HERBS), Irit(5297, 44, 209, 6, 43, 48.5, 20, HERBS), Avantoe(5298, 50, 211, 7, 54.4, 61.5, 20,
				HERBS), Kwuarm(5299, 56, 213, 6, 69, 78, 20, HERBS), Snapdragon(5300, 62, 3051,
												6, 87.5, 98.50, 20,
						HERBS), Cadantine(5301, 67, 215, 6, 106.5, 120, 20, HERBS), Lantadyme(
														5302, 73, 2485, 6, 134.5, 151.50, 20,
								HERBS), Dwarf(5303, 79, 217, 6, 170.5, 192, 20, HERBS), Torstol(5304, 85, 219, 6, 199.5, 224.5, 20,
																HERBS), Fellstalk(21621, 91, 21626, 6, 225, 315.6, 20,
																		HERBS), Wergali(14870, 46, 213, 8, 52.8, 52.8,
																				20, HERBS), Gout(6311, 65, 3261, 27,
																						105, 45, 20, HERBS),

		/**
		 * Flowers
		 */
		Marigold(5096, 2, 6010, 0, 8.5, 47, 5, FLOWERS), Rosemary(5097, 11, 6014, 1, 12, 66.5, 5, FLOWERS), Nasturtium(
				5098, 24, 6012, 2, 19.5, 111, 5,
				FLOWERS), Woad(5099, 25, 1793, 3, 20.5, 115.5, 5, FLOWERS), Limpwurt(5100, 26, 225, 4, 21.5, 120, 5,
						FLOWERS), White_lily(14589, 52, 14583, 6, 70, 250, 20, 4, -1, FLOWERS),

		/**
		 * Hops
		 */
		Barley(5305, 3, 6006, 9, 8.5, 9.5, 10, 4, 1, new Item(6032, 3), HOPS), Hammerstone(5307, 4, 5994, 0, 9, 10, 10,
				4, 1, new Item(6010, 1), HOPS), Asgarnian(5308, 8, 5996, 1, 10.9, 12, 10, 5, 3, new Item(5458, 1),
						HOPS), Jute(5306, 13, 5931, 10, 13, 14.5, 10, 5, 3, new Item(6008, 6), HOPS), Yanillian(5309,
								16, 5998, 3, 14.5, 16, 10, 6, 1, new Item(5968, 1), HOPS), Krandorian(5310, 21, 6000, 5,
										17.5, 19.5, 10, 7, new Item(5478, 3),
										HOPS), Wildbood(5311, 28, 6002, 7, 23, 26, 10, 7, 1, new Item(6012, 1), HOPS),

		/**
		 * Trees
		 */
		Oak(5370, 15, 6043, 1, 466.3, 14, 40, new Item(5968, 1), TREES), Willow(5371, 30, 6045, 6, 1456.5, 25, 40, 6,
				new Item(5386, 1), TREES), Maple(5372, 45, 6047, 17, 3402.4, 45, 40, 8, new Item(5396, 1), TREES), Yew(
						5373, 60, 6049, 26, 7086.9, 81, 40, 10, new Item(6016, 10),
						TREES), Magic(5374, 75, 6051, 41, 13768.3, 145.5, 40, 12, new Item(5974, 25), TREES),

		/**
		 * Trees of the fruits :)
		 */
		Apple(5496, 27, 1955, 1, 1199.5, 22, 160, 6, new Item(5986, 9), FRUIT_TREES), Banana(5497, 33, 1963, 26, 1841.5,
				28, 160, 6, new Item(5386, 4),
				FRUIT_TREES), Orange(5498, 39, 2108, 65, 2470.2, 35.5, 160, 6, new Item(5406, 3), FRUIT_TREES), Curry(
						5499, 42, 5970, 90, 2906.9, 40, 160, 6, new Item(5416, 5), FRUIT_TREES), Pineapple(5500, 51,
								2114, 129, 4605.7, 57, 160, 6, new Item(5982, 10), FRUIT_TREES), Papaya(5501, 57, 5972,
										154, 6146.4, 72, 160, 6, new Item(2114, 10), FRUIT_TREES), Palm(5502, 68, 5974,
												193, 10150.1, 110.5, 160, 6, new Item(5972, 15), FRUIT_TREES),

		/**
		 * Bushes of the bush
		 */
		Redberry(5101, 10, 1951, -4, 64, 11.5, 20, 5, new Item(5478, 4), BUSHES), Cadavaberry(5102, 22, 753, 6, 102.5,
				18, 20, 6, new Item(5968, 3),
				BUSHES), Dwellberry(5103, 36, 2126, 19, 177.5, 31.5, 20, 7, new Item(5406, 3), BUSHES), Jangerberry(
						5104, 48, 247, 31, 284.5, 50.5, 20, 8, new Item(5982, 6), BUSHES), Whiteberry(5105, 59, 239, 42,
								437.5, 78, 20, 8, new Item(6004, 8),
								BUSHES), Poison_ivy(5106, 70, 6018, 188, 675, 120, 20, 8, BUSHES),
		...
		private Item protectionItem;

		private ProductInfo(int seedId, int level, int productId, int configIndex, double plantingExperience,
				double experience, int cycleTime, int maxStage, int stageSkip, Item protectionItem, int type) {
			this.seedId = seedId;
			this.level = level;
		...
		private ProductInfo(int seedId, int level, int productId, int configIndex, double plantingExperience,
			...
			this(seedId, level, productId, configIndex, plantingExperience, experience, cycleTime, maxStage, stageSkip,
					null, type);
		}

		private ProductInfo(int seedId, int level, int productId, int configIndex, double plantingExperience,
				double experience, int cycleTime, int maxStage, Item protectionItem, int type) {
			this(seedId, level, productId, configIndex, plantingExperience, experience, cycleTime, maxStage, 0,
					protectionItem, type);
		}

		private ProductInfo(int seedId, int level, int productId, int configIndex, double plantingExperience,
				double experience, int cycleTime, int maxStage, int type) {
			this(seedId, level, productId, configIndex, plantingExperience, experience, cycleTime, maxStage, 0, null,
					type);
		}

		private ProductInfo(int seedId, int level, int productId, int configIndex, double plantingExperience,
				double experience, int cycleTime, Item protectionItem, int type) {
			this(seedId, level, productId, configIndex, plantingExperience, experience, cycleTime, 4, 0, protectionItem,
					type);
		}

		private ProductInfo(int seedId, int level, int productId, int configIndex, double plantingExperience,
				double experience, int cycleTime, int type) {
			this(seedId, level, productId, configIndex, plantingExperience, experience, cycleTime, 4, 0, null, type);
		}

		public Item getProtectionItem() {
	...
	public static enum SpotInfo {
		...
		Talvery_Tree(8388, TREES), Falador_Garden_Tree(8389, TREES), Varrock_Tree(8390, TREES), Lumbridge_Tree(8391,
				TREES), Gnome_Tree(19147, TREES), Member_Tree(208395, TREES),

		Gnome_Strong_Fruit_Tree(7962, FRUIT_TREES), Gnome_Fruit_Tree(7963, FRUIT_TREES), Brimhaven_Fruit_Tree(7964,
				FRUIT_TREES), Catherby_Fruit_Tree(7965, FRUIT_TREES), Lletya_Fruit_Tree(28919, FRUIT_TREES), Member_Fruit_Tree(208050, FRUIT_TREES),

		Falador_Allotment_North(8550, ALLOTMENT), Falador_Allotment_South(8551,
				ALLOTMENT), Catherby_Allotment_North(8552, ALLOTMENT), Catherby_Allotment_South(8553,
						ALLOTMENT), Ardougne_Allotment_North(8554, ALLOTMENT), Ardougne_Allotment_South(8555,
								ALLOTMENT), Canfis_Allotment_North(8556, ALLOTMENT), Canfis_Allotment_South(8557,
										ALLOTMENT), Harmony_Allotment(21950, ALLOTMENT),

		Yannile_Hops_Patch(8173, HOPS), Talvery_Hops_Patch(8174, HOPS), Lumbridge_Hops_Patch(8175,
				HOPS), McGrubor_Hops_Patch(8176, HOPS),

		Falador_Flower(7847, FLOWERS), Catherby_Flower(7848, FLOWERS), Ardougne_Flower(7849,
				FLOWERS), Canfis_Flower(7850, FLOWERS), wildy_ruins(37988, FLOWERS),

		Champions_Bush(7577, BUSHES), Rimmington_Bush(7578, BUSHES), Etceteria_Bush(7579,
				BUSHES), South_Arddougne_Bush(7580, BUSHES),

		Falador_Herb_Patch(8150, HERBS), Catherby_Herb_Patch(8151, HERBS), Ardougne_Herb_Patch(8152,
				HERBS), Canfis_Herb_Patch(8153, HERBS), TROLL_HEIM(18816, HERBS), Member_Herb_Patch(208138, HERBS),

		Falador_Compost_Bin(7836, COMPOST), Catherby_Bin(7837, COMPOST), Port_Phasymatis_Bin(7838,
				COMPOST), Ardougn_Bin(7839, COMPOST), Taverly_Bin(66577, COMPOST);
		...
		private SpotInfo(int objectId, int type) {
			...
			configFileId = ObjectDefinitions.getObjectDefinitions(objectId).configFileId;
			this.type = type;
		}
	}

	public enum Gardeners {// We need type and object id and npcId
		ALAIN(2339, 8388, TREES), BOLONGO(2343, 7962, FRUIT_TREES), DANTAERA(2324, 8552, ALLOTMENT), DREVEN(2335, 7577,
				BUSHES), ELLENA(2331, 7965, FRUIT_TREES), ELSTAN(2323, 8550, ALLOTMENT), FAYETH(2342, 8391,
						TREES), GARTH(2330, 7964, FRUIT_TREES), GILETH(2344, 7963, FRUIT_TREES), AMAETHWR(2860, 28919,
								FRUIT_TREES), HESKEL(2340, 8389, TREES), KRAGEN(2325, 8554, ALLOTMENT), LYRA(2326, 8556,
										ALLOTMENT), PRISSY_SCILLA(1037, 19147, TREES), Francis(2327, 8174,
												HOPS), RHAZIEN(2337, 7579, BUSHES), RHONEN(2334, 8176, HOPS), SELENA(
														2332, 8173, HOPS), TARIA(2336, 7578, BUSHES), TORRELL(2338,
																7580, BUSHES), TREZNOR(2341, 8390, TREES), MY_ARM(4947,
																		18816, HERBS), VASQUEN(2333, 8175, HOPS);

		private static Map<Integer, Gardeners> GARDENERS = new HashMap<Integer, Gardeners>();// NpcId/ObjectId

		static {
			for (Gardeners GARDENER : Gardeners.values()) {
				GARDENERS.put(GARDENER.npcId, GARDENER);
			}
		}
		...
		private Gardeners(int npcId, int objectId, int type) {
			this.npcId = npcId;
			this.objectId = objectId;
			objectId2 = objectId + 1;
			this.type = type;
		...
		public static Gardeners getGardeners(int npcId) {
			return GARDENERS.get(npcId);
		}
	}

	public boolean isGardening(int npcId, int option) {
		for (Gardeners garnder : Gardeners.values()) {
			if (npcId == garnder.getNpcId()) {
				switch (option) {
				case 1:
					player.getDialogueManager().startDialogue("GardenersD", npcId, -1);
					break;
				case 2:
					player.getDialogueManager().startDialogue("GardenersD", npcId, 1);
					break;
				case 3:
					player.getDialogueManager().startDialogue("GardenersD", npcId, 2);
					break;
				}
				return true;
			}
	...
	public void handleFarming(SpotInfo info, Item item, int optionId) {// TODO
		...
		if (!spot.isCleared()) {
			if (item != null) {
				if (info.type == COMPOST) {
					...
					player.getPackets().sendGameMessage("The patch needs weeding first.");
				}
			} else {
				switch (optionId) {
				case 1: // rake
	...
	public void startHarvestingAction(final FarmingSpot spot) {
		...
		player.getActionManager().setAction(new Action() {
			...
			public int processWithDelay(Player player) {
				spot.harvestAmount--;
				/*if (spot.productInfo.type == HERBS) {
					player.dailyfarming++;
					if (player.dailyfarming == 10) {
						player.sendMessage(Colors.lightGray + "<img=6>You have completed the Daily Money Maker: Harvest 10 herbs! Your rewards have been placed in your bank.");
						player.getBank().addItem(5304, 10, true);
						player.getBank().addItem(989, 1, true);
					}
				}*/
				if (player.challengeid == 52 && player.challengeamount > 0 && spot.productInfo.productId == 199) {
					DailyChallenges.UpdateChallenge(player);
				}
				if (player.challengeid == 53 && player.challengeamount > 0 && spot.productInfo.productId == 209) {
					DailyChallenges.UpdateChallenge(player);
				}
				if (player.challengeid == 54 && player.challengeamount > 0 && spot.productInfo.productId == 219) {
					DailyChallenges.UpdateChallenge(player);
				}
				...
				if (player.getEquipment().getCapeId() == 29991) {
					player.getBank().addItem(spot.productInfo.productId, 1, true);
				} else 	if (player.getEquipment().getCapeId() == 20771 && player.getSkills().getXp(Skills.FARMING) >= 104273167) {
					player.getBank().addItem(spot.productInfo.productId, 1, true);
				} else {
	...
	public void clearFarmingPatch(final FarmingSpot spot) {
		...
		player.getDialogueManager().startDialogue(new Dialogue() {
			...
			@Override
			public void start() {
				sendOptionsDialogue("CLEAR FARMING PATCH?", "Yes", "No");
			}
					...
					player.getActionManager().setAction(new Action() {
						...
						public boolean process(Player player) {
							if (stage != 2) {
								...
								player.getPackets()
										.sendGameMessage("You have successfully cleared this patch for new crops.");
								player.setNextAnimation(new Animation(-1));
								spot.setIdle();
								return false;
							}
	...
	public boolean startFarmingCycle(FarmingSpot spot, Item item) { // check if
		...
		if (spot == null || productInfo == null || spot.spotInfo.type != productInfo.type || !spot.isCleared()
			...
			player.getPackets()
					.sendGameMessage(spot == null ? "The patch needs weeding first."
							: !spot.isCleared() ? "The patch needs weeding first."
									: productInfo == null ? "Nothing intresting happens."
											: spot.spotInfo.type != productInfo.type
													? "You can only plant " + item.getName().toLowerCase() + "s in "
															+ (beginsWithVowel(getPatchName(productInfo.type)) ? "an "
																	: "a ")
															+ getPatchName(productInfo.type) + "."
													: "");
			return false;
		}
		...
		if (!player.getInventory().containsItemToolBelt(isTree ? 952 : 5343)) {
			player.getPackets().sendGameMessage(isTree ? "You need a spade to plant the sappling into the dirt."
					: "You need a seed dibber to plant the seed in the dirt.");
			return true;
			...
			player.getPackets().sendGameMessage("You don't have enough " + item.getDefinitions().getName().toLowerCase()
					+ " to plant " + (beginsWithVowel(patchName) ? "an" : "a") + " " + patchName + " patch.");
			return true;
	...
	public String getDetails(FarmingSpot spot) {
		String patchName = getPatchName(spot.spotInfo.type);
		return "This is " + (beginsWithVowel(patchName) ? "an" : "a") + " " + patchName + " patch." + " The soil has "
				+ (!spot.hasCompost() ? "not been treated."
						: spot.getCompost() ? "been treated with compost."
								: spot.getSuperCompost() ? "been treated with supercompost." : "");
	}
	...
	private void sendInspect(FarmingSpot spot) {// TODO
		if (spot == null) {
			return;
		}
		if (spot.productInfo == null && spot.isCleared()) {
			player.getPackets().sendGameMessage(getDetails(spot) + " The patch is empty and weeded.");
		} else if (spot.productInfo == null && !spot.isCleared()) {
			player.getPackets().sendGameMessage(getDetails(spot) + " The patch needs weeding.");
		} else if (spot.productInfo != null) {
			if (spot.isDead()) {
				player.getPackets().sendGameMessage(
						getDetails(spot) + " The patch has become diseased and dead for not curing it.");
			} else if (spot.isDiseased()) {
				player.getPackets().sendGameMessage(getDetails(spot) + " The patch has become diseased.");
			} else if (!spot.reachedMaxStage()) {
				player.getPackets().sendGameMessage(getDetails(spot) + " The patch has something growing in it.");
			} else {
				player.getPackets().sendGameMessage(getDetails(spot) + " The patch is fully grown.");
			}
		}
	...
	public void useWateringCan(Item item) {
	...
	public class FarmingSpot implements Serializable {
		...
		public FarmingSpot(SpotInfo spotInfo) {
			...
			harvestAmount = 0;
			attributes = new boolean[12]; // diseased, watered, dead,
			// firstCycle, usingCompost,
			// usingSuperCompost, isProtected, inAction;
			renewCycle();
			spots.add(this);
		}
		...
		private void resetCycle() {
			...
			for (int index = 0; index < attributes.length; index++) {
				if (index == 4 || (index == 7 || index == 8) && productInfo != null) {
					continue;
				}
			...
			if (isDiseased()) {
				if (reachedMaxStage()) {
					...
					if (isFirstCycle()) {
						...
						if (!isProtected() && player.farmingperk != true) {
							setDead(true);
						} else {
							setDiseased(false);
						}
		...
		public void renewCycle() {
			...
			if (productInfo != null) {
				cycleTime += Settings.DEBUG ? constant * 2 : constant * productInfo.cycleTime;
			} else {
				cycleTime += constant * 3;
			}
		}

		public void renewCycle(boolean resetAttributes) {
			long constant = 30000L;
			if (productInfo != null) {
				cycleTime += Settings.DEBUG ? constant * 2 : constant * productInfo.cycleTime;
			} else {
		...
		public void setCompost(boolean compost) {
			attributes[7] = compost;
		}

		public void setIsProtected(boolean isProtected) {
			attributes[10] = isProtected;
		}
