 ...
 */
public class DharokerBehaviour extends Behaviour {

    public DharokerBehaviour() {
        super(new RandomWalkAction(), new OutOfFoodTeleportAction(), new EatFoodAction(), new CastSpellAction(), new SwitchToDharoksAxeAction(), new EnablePrayerAction(), new DrinkPotionAction(), new DrinkRestoreAction(), new AttackPlayerAction());
    }
