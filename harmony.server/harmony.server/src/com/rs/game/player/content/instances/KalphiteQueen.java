...
// import com.rs.game.player.controlers.instances.KalphiteQueenC;
//
/// **
// *
// * @author Mr_Joopz
...
// }
//
// public KalphiteQueen (final Player player) {
// setOwner(true);
// loadMap(player);
// }
//
...
// RegionBuilder.copyAllPlanesMap(433, 1185, boundChunk[0], boundChunk[1], 40);
...
// @Override
// public void run() {
// KalphiteQueenC.addNpcToInstance(player, null, null);
// player.getControlerManager().startControler("KalphiteQueenC");
// player.unlock();
// }
// });
...
// player.setNextWorldTile(new WorldTile(getBaseX() + 15, getBaseY() + 10, 0));
// }
//
