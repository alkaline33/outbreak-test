...
public class DungeonConstants {
	 ...
	 * floor types
	 */
	public static final int FROZEN_FLOORS = 0
							,ABANDONED_FLOORS = 1
							,FURNISHED_FLOORS = 2
							,ABANDONED2_FLOORS = 3
							,OCCULT_FLOORS = 4
	 ...
	 * dungeon sizes
	 */
	public static final int SMALL_DUNGEON = 0
							,MEDIUM_DUNGEON = 1
							,LARGE_DUNGEON = 2;
	 ...
	 * door directions
	 */
	public static final int EAST_DOOR = 0
							,WEST_DOOR = 1
							,NORTH_DOOR = 2
							,SOUTH_DOOR = 3;
	...
	public static final int[][] DANGEROUS_MUSICS = new int[][] {
		//FROZEN_FLOORS
				new int[] {
						832, 834, 827, 811, 824, 808, 831
						, 810, 833, 837, 
						814, 821 //equal to boss unlockable
				}
	};
	...
	public static final int[][] SAFE_MUSICS = new int[][] {
		//FROZEN_FLOORS
				new int[] {
						804, 805, 806, 807, 812, 813, 826
						, 823, 825, 826, 828, 829, 830, 835
						, 836
	...
	public static final StartRoom[][] START_ROOMS = new StartRoom[][] {
		//FROZEN_FLOORS
		new StartRoom[] {
				new StartRoom(new int[] {1,2,3,4,5,6}, 14, 632, EAST_DOOR, WEST_DOOR, NORTH_DOOR, SOUTH_DOOR),
