...
public final class SkillCapeCustomizer {
	...
	public static void costumeColorCustomize(Player player) {
		player.getTemporaryAttributtes().put("COSTUME_COLOR_CUSTOMIZE", Boolean.TRUE);
		player.getInterfaceManager().sendInterface(19);
		;
		player.getPackets().sendConfig(426, player.getEquipment().getCostumeColor());
	}
