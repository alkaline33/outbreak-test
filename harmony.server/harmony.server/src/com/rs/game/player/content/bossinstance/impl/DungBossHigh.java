...
public class DungBossHigh extends BossInstance {
	...
	public DungBossHigh(Player owner) {
		super(new WorldTile(3442, 3738, HEIGHT), new WorldTile(3456, 3754, HEIGHT), HEIGHT, 3, 3, owner);
		// TODO Auto-generated constructor stub
	}

	@Override
	public void start() {
		NPC npc = new NPC(9911, getWorldTile(9, 8), -1, true, false);
