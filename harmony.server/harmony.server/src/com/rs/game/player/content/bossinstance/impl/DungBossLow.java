...
public class DungBossLow extends BossInstance {
	...
	public DungBossLow(Player owner) {
		super(new WorldTile(3500, 9672, HEIGHT), new WorldTile(3509, 9681, HEIGHT), HEIGHT, 3, 3, owner);
		// TODO Auto-generated constructor stub
	}

	@Override
	public void start() {
		NPC npc = new NPC(11750, getWorldTile(9, 8), -1, true, false);
