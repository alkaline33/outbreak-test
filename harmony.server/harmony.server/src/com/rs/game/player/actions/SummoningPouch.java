...
public enum SummoningPouch {
	...
	/**
	 * private final int pouchId; private final int levelRequired; private final
	 * double createExperience; private final int npcId; private final double
	 * summonExperience; private final int summonCost; private final Item[] items;
	 */
	...
	UNICORN_STALLION_POUCH(12039, 89, 154.4, 6822, 1.8, 9, new Item(12159), new Item(237), new Item(12155), new Item(12183, 203)),
