package com.rs.game.player.dialogues.construction;
...
public class ServantDialogue extends Dialogue {
	...
	public int NORMAL = 9827;
	
	private static final String[] BEGINNING_MESSAGE =
	{

		"Ah, I visited with her Royal Highness for the Diamond Jubillee," + " and I liked it so much I never left! However, I find myself without" + " an income. Care to hire me, for only 1,000,000 coins?",
		"'Allo mate! Got a job going? Only 100,000 coins!",

		"Oh! Please hire me sir! I'm very good - well, I'm not bad- and my fee's only 200,000 coins.",

		"You're not aristocracy, but I suppose you'd do. Do you want a good cook for 400,000 coins?",

		"Good day, sir! Would sir care to hire a good butler for 1,000,000 coins? ",

		"Greetings! I am Alathazdrar, butler to the Demon Lords, and I offer thee my services for a mere 5,000,000 coins!",
	...
	private static final String[] WHAT_CAN_YOU_DO =
	{
		...
		"I, sir, am the finest cook in all Harmony! I can also make good time going to the bank or sawmill.",
	...
	public void run(int interfaceId, int componentId) {
		...
		if (stage == -1) {
			...
			if (player.getInventory().getNumerOf(995) < servant.getCost()) {
				sendDialogue("You don't have enough to cover the costs.");
				stage = 10;
				return;
			} else if (player.getSkills().getLevel(Skills.CONSTRUCTION) < servant.getLevel()) {
