...
public class CutscenesHandler {
	...
	public static final void init() {
		try {
			...
			Class<Cutscene> value8 = (Class<Cutscene>) Class
					.forName(HweenEvent.class.getCanonicalName());
			handledCutscenes.put("HweenEvent", value8);
			Class<Cutscene> value9 = (Class<Cutscene>) Class
					.forName(SunfreetsEnd.class.getCanonicalName());
			handledCutscenes.put("SunfreetsEnd", value9);
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
