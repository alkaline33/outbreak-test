...
public class Projectile {
	...
	public Projectile(WorldTile from, WorldTile to, boolean adjustFlyingHeight, boolean adjustSenderHeight,
			int senderBodyPartId, int graphicId, int startHeight, int endHeight, int startTime, int endTime, int slope,
			int angle, double speed) {
		this.from = from;
		this.to = to;
