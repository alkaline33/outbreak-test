...
public class BlinkSpawn extends CombatScript {
	// blue gfxs - 2854-2855
	// blue ranged - 2853
	...
	public int attack(final NPC npc, final Entity target) {
		...
		if (!specialRapidMagic && Utils.random(15) == 2 && !sprayAttack
				|| !specialRapidMagic && npc.getHitpoints() <= 2000
				&& !sprayAttack) {
			npc.setNextForceTalk(new ForceTalk(
					(npc.getHitpoints() <= 2000 ? "MASTER! This Soul Called You Weak!"
							: "MASTER! This Soul Called You Weak!")));
			World.spawnNPC(12878, new WorldTile(2142, 5535, 3), -1, true, true);
			World.sendWorldMessage(Colors.orange +"<img=7>Blink has spawned! Help kill him @ ;;blink!!!", false);
