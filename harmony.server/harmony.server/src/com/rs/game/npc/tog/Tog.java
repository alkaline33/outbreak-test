...
public class Tog extends FightCavesNPC {

	private boolean spawnedMinions;
	private TrialOfTheGods controler;
	
	public Tog(int id, WorldTile tile, TrialOfTheGods trialOfTheGods) {
		super(id, tile);
		this.controler = trialOfTheGods;
	}
