		...
		case 6:
			...
			case 0:
				...
				sendOptionsDialogue("Choose your reward:",
						"A Pet Jad", "TokHaar-Kal Box");
			break;
			case 1:
				if (componentId == OPTION_2) {
					stage = 2;
					sendNPCDialogue(npcId, 9827, "The TokHaar-Kal is a powerful cape that will let others see that you have mastered the Fight Kiln. In addition to this, it provides several stat boosts." );
				}else{
					stage = 3;
					sendNPCDialogue(npcId, 9827, "The pet jad is a very small version of the Jad itself, but is too young to experience battles!");
				}
			break;
			case 2:
			case 3:
				stage = (byte) (stage == 2 ? 4 : 5);
				sendOptionsDialogue("Accept the "+ (stage == 4 ? "Pet Jad" : "TokHaar-Kal") + "?",
						"Yes.", "No.");
			break;
			case 4:
			case 5:
