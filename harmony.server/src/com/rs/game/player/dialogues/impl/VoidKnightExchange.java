...
public class VoidKnightExchange extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE, "Who are you?", "What is this place?", "Can you exchange my Commendations for training?", "I'm fine thanks.");
			stage = 0;
		} else if (stage == 0) {
