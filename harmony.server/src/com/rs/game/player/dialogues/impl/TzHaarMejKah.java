...
public class TzHaarMejKah extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 1:
			stage = 2;
			sendNPCDialogue(npcId, 9827, "This is the Fight Pit. TzHaar-Xil made it for their sport but many JalYt come here to fight, too.<br>If you are wanting to fight then enter the cage, you will be summoned when next round is ready to begin." );
		break;
		case 2:
			stage = 3;
			sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE,
		...
		case 4:
			stage = 5;
			sendNPCDialogue(npcId, 9827, "No rules, you use whatever you want. Last person standing wins and is declared champion, they stay in the pit for next fight.");
		break;
		case 5:
			stage = 6;
			sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE,
		...
		case 7:
			stage = 8;
			sendNPCDialogue(npcId, 9827, "You ask a lot questions.<br>Champion gets TokKul as reward, more fights the more TokKul they get.");
		break;
		case 8:
			stage = 9;
		...
		case 23:
			stage = -2;
			sendNPCDialogue(npcId, 9827, "Ah that would be Y'Haar-Mej-"+(FightPits.currentChampion == null ? "none" : FightPits.currentChampion)+"!");
		break;
		default:
			end();
		break;
