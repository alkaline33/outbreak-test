...
public class ClansManager {
	...
	public static long clantotalxp;
	...
	public static void viewClanmateDetails(Player player, ClanMember member) {
		...
		player.getPackets().sendRunScript(4319, new Object[] {});
	}
	...
	public ClansManager(Clan clan) {
		this.clan = clan;
		channelPlayers = new ArrayList<Player>();
		membersOnline = new ArrayList<Player>();
		bannedChannelPlayers = new HashMap<String, Long>();
	...
	public static void openClanMottifInterface(Player player) {
		...
		//System.out.println(manager.clan.getMottifColors());
	}
	...
	public static boolean connectToClan(Player player, String clanName, boolean guest) {
		...
		if (manager != null || guest && player.getClanName() != null && clanName.equalsIgnoreCase(player.getClanName())) {
			// connected
			// to
			// a
