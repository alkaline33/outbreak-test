...
//		// if (p.getLockDelay() > 0)
//		// return;
//        p.getInventory().deleteItem(29580, 1);
...
//		case 1:
//		case 14:
//			vr = Utils.random(0, 30);
//			if (vr == 0) {
//				r = Utils.random(ULTRA_RARE.length);
//				q = ULTRA_RARE[r][1];
//				reward = ULTRA_RARE[r][0];
//				// p.getBank().addItem(ULTRA_RARE[r][0], q, true);
...
//				// p.getBank().addItem(VERY_RARE[r][0], q, true);
