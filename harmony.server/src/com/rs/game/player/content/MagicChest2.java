 ...
 */
public class MagicChest2 {

    private static final int COMMON[][] = {{3140, 1},{14479, 1},{4087, 1},{11335, 1}};
    private static final int UNCOMMON[][] = {{4714, 1},{4712, 1},{4708, 1},{4730, 1},{4728, 1},{4724, 1},{4738, 1},{4736, 1},{4732, 1},{4759, 1},{4757, 1},{4753, 1},{4751, 1},{4749, 1},{4745, 1},{4722, 1},{4720, 1},{4716, 1}};
    private static final int RARE[][] = {{21787, 1},{21790, 1},{21793, 1},{11283, 1},};
    private static int reward, r, c, q;

    private static void handle(Player p) {
    	if (!p.getInventory().containsItem(29541, 1)) {
			...
			public void run() {
				if (loop == 0) {
			        ...
			        switch (r) {
						...
						if (p.getInventory().contains(29541)) {
							p.getInventory().deleteItem(29541, 1);
