package com.rs.game.player.content.raids.trioboss;
...
public class TrioPlaying extends Controler {
	...
	public void leave() {
		...
		TheTrioWaiting.removePlayingPlayer(player, team);
	}
			...
			public void run() {
				if (loop == 0) {
					...
					player.setNextWorldTile(new WorldTile(
							team == TheTrioWaiting.TRIO1 ? TheTrioWaiting.LOBBY
									: TheTrioWaiting.LOBBY, 1));
	...
	public boolean logout() {
		player.setLocation(new WorldTile(TheTrioWaiting.LOBBY, 0));
		return true;
	}
