...
public class NoobChest {

	private static final int COMMON[][] = { { 995, 50000 }, { 995, 100000 } };
	private static final int VERY_RARE[][] = { { 995, 500000 }, { 4151, 1 } };// noob armour
	...
	private static void handle(Player p) {
		...
		p.getInventory().deleteItem(29356, 1);
