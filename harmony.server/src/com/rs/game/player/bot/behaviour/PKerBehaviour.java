...
public class PKerBehaviour extends Behaviour {
    ...
    public PKerBehaviour() {
        super(new RandomWalkAction(), new OutOfFoodTeleportAction(), new EatFoodAction(), new CastSpellAction(), new PerformSpecialAttackAction(), new EnablePrayerAction(), new DrinkPotionAction(), new DrinkRestoreAction(), new AttackPlayerAction());
    }
