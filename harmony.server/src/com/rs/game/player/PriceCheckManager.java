...
public class PriceCheckManager {
	...
	public void openPriceCheck() {
		if (World.TheCalamity(player) || World.TheCalamityWaiting(player) || player.getControlerManager().getControler() instanceof CalamityPlaying) {
			player.sendMessage("You cannot open the price checker here.");
			return;
		}
