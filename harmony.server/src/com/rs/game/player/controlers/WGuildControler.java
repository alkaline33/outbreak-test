...
public static final WorldTile HOME = new WorldTile(2850, 3349, 0);
...
public boolean endCon() {
	if (World.isWarriorgArea(null) == false);
...
int itemId = 8844;
if (player.getEquipment().getShieldId() == 29025)
	itemId = 20072;
for(int i = 0; i < DEFENDERS.length; i++) {
if(player.getInventory().containsItem(DEFENDERS[i], 1) || player.getEquipment().getShieldId() == DEFENDERS[i]) {
