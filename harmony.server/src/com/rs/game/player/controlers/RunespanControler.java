...
public class RunespanControler extends Controler {
	public static WorldTile WIZARD_TOWER = new WorldTile(3107, 6160, 1);
	...
	private static int AIR_RUNE = 24215, EARTH_RUNE = 24216, WATER_RUNE = 24214, MIND_RUNE = 24217, FIRE_RUNE = 24213,
			...
			COSMIC_RUNE = 24223, ASTRAL_RUNE = 24224, LAW_RUNE = 24222, BLOOD_RUNE = 24225, DEATH_RUNE = 24219, SOUL_RUNE = 24226 ;
	...
	public boolean processMagicTeleport(WorldTile toTile) {
		...
		player.sendMessage("The runes are removed from you as you leave");
			return true;
		}
	...
	public void forceClose() {
		player.getInventory().deleteItem(RUNE_ESSENCE, 2147483647);
		player.getInventory().deleteItem(AIR_RUNE, 2147483647);
		player.getInventory().deleteItem(EARTH_RUNE, 2147483647);
		player.getInventory().deleteItem(WATER_RUNE, 2147483647);
		player.getInventory().deleteItem(FIRE_RUNE, 2147483647);
		player.getInventory().deleteItem(MIND_RUNE, 2147483647);
		player.getInventory().deleteItem(NATURE_RUNE, 2147483647);
		player.getInventory().deleteItem(DEATH_RUNE, 2147483647);
		player.getInventory().deleteItem(BLOOD_RUNE, 2147483647);
		player.getInventory().deleteItem(SOUL_RUNE, 2147483647);
		player.getInventory().deleteItem(BODY_RUNE, 2147483647);
		player.getInventory().deleteItem(LAW_RUNE, 2147483647);
		player.getInventory().deleteItem(COSMIC_RUNE, 2147483647);
		player.getInventory().deleteItem(ASTRAL_RUNE, 2147483647);
		player.getInventory().deleteItem(CHAOS_RUNE, 2147483647);
		player.getInventory().deleteItem(ELEMENTAL_RUNE, 2147483647);
		exitRunespan();
	}
}
