...
public class BoxAction extends Action {
	...
	public enum HunterNPC {
		...
		BLACK_CHINCHOMPA(33912, new Item[] { new Item(29448, 1) }, 73, 315, HunterEquipment.BOX, 28557, 19192, new Animation(5184), new Animation(5185)),
		
		GRENWALL(7010, new Item[] {new Item(12539, 20)}, 77, 1100, HunterEquipment.BOX, 74526, 74527, new Animation(-1), new Animation(-1)),
		...
		// MONKEY(6942, new Item[] {new Item(2201)}, 27, 100, HunterEquipment.BOX,
		// 28557, 19192, new Animation(8343), new Animation(8345)),
	...
	public int getTrapAmount(Player player) {
		...
		return trapAmount += player.huntertrapboost ? 2 : 0;
	}
