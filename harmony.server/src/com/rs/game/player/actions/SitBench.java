...
public class SitBench extends Action {

    private int bench;
    private WorldTile originalTile;
    private WorldTile chairTile;
    private boolean tped;
    public SitBench(Player player, int bench, WorldObject object) {
	this.bench = bench;
	...
	player.setNextAnimation(new Animation(HouseConstants.BENCH_EMOTES[bench]));
	return 0;
    }
