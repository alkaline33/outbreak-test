...
public class FlyingEntityHunter {
	...
	public static void captureFlyingEntity(final Player player, final NPC npc) {
		...
		if (weaponId != 11259 && weaponId != 10010) {
		...
		player.setNextAnimationNoPriority(new Animation(6606));
		player.lock(3);
			...
			public void run() {
				if (isSuccessful(player, instance.getLevel(), new DynamicFormula() {
					...
					if (isImpling) {
						...
						player.getInventory().deleteItem(new Item(10012, 1));
					}
					player.getInventory().addItem(new Item(instance.getReward(), 1));
					player.getSkills().addXp(Skills.HUNTER, instance.getPuroExperience());
					npc.setRespawnTaskImpling();
					player.sendMessage("You manage to catch the " + name.toLowerCase() + ".");
				} else {
					if (isImpling) {
						npc.setNextForceTalk(new ForceTalk("Tehee, you missed me!"));
						WorldTile teleTile = npc;
						for (int trycount = 0; trycount < 10; trycount++) {
							teleTile = new WorldTile(npc, 5);
							if (World.isTileFree(npc.getPlane(), teleTile.getX(), teleTile.getY(), player.getSize()))
								break;
							teleTile = npc;
						}
						npc.setForceWalk(teleTile);
	...
	public static void openJar(Player player, FlyingEntities instance, int slot) {
		...
		if (Utils.random(4) == 0) {
			...
			player.applyHit(new Hit(player, Utils.random(5, 15), HitLook.REGULAR_DAMAGE));
		}
	}
	...
	public enum FlyingEntities {
		...
		EARTH_IMPLING(1031, 11244, 126, 177, 36, new Item[] { new Item(444, 1), new Item(557, 32), new Item(1441, 6), new Item(1442, 1), new Item(2353, 1), new Item(5104, 1), new Item(5535, 1), new Item(6032, 1), new Item(444, 1), new Item(2353, 1), new Item(557, 1) }, new Item[] { new Item(237, 1), new Item(447, 1), new Item(1273, 1), new Item(454, 6), new Item(1487, 1), new Item(5311, 2), new Item(5294, 2) }, new Item[] { new Item(448, 1), new Item(1606, 2), new Item(6035, 2), }, new Item[] { new Item(1603, 1), new Item(5303, 1) }),
		...
		/* Steel platebody */, new Item(1636, 10), new Item(2135, 25) /*
									 ...
									 */, new Item(12156, 1) /* Honeycomb */, new Item(1934, 14), new Item(6033, 12) /* Compost */, new Item(6010, 1) /* Marigolds */, new Item(12148, 3), new Item(12134, 1) /*
																																																				 ...
																																																				 */, new Item(12153, 1), new Item(1520, 65) /*
																																																															 ...
																																																															 */, new Item(5934, 2), new Item(1964, 25) /* Banana */, new Item(8431, 2), new Item(3138, 1) /*
																																																																																							 * Potato cactus
																																																																																							 */, new Item(2462, 1), new Item(9737, 2), new Item(9976, 4) /* Chinchompa */, new Item(10117, 1), new Item(383, 1) /*
																																																																																																																				 * Raw shark
																																																																																																																				 */, new Item(1444, 1), new Item(1444, 1) /*
																																																																																																																															 * Water talisman
																																																																																																																															 */, }, new Item[] { new Item(249, 4) /*
																																																																																																																																									 * Clean guam
			...
			public void effect(Player player) {
				if (Utils.random(2) == 0) {
					...
					player.getInventory().addItemDrop(charm.getId(), charmAmount);
				}
			}
		},
																																																																												 ...
																																																																												 */, new Item(4095, 1) /*
																																																																																		 ...
																																																																																		 */, new Item(2364, 2) /*
																																																																																								 ...
																																																																																								 */, new Item(1603, 1) /* Ruby */, }, new Item[] { new Item(1215, 1) /*
																																																																																																										 ...
																																																																																																										 */, new Item(1185, 1) /*
																																																																																																																 * Rune sq shield
																																																																																																																 */, new Item(1601, 1) /* Diamond */, new Item(5287, 1) }, new Item[] { new Item(5300, 1) /*
																																																																																																																																							 * Snapdragon seed
		...
		KINGLY_IMPLING(7903, 15517, 434, 617, 91, new Item[] { new Item(1705, Utils.random(3, 11)), new Item(1684, 3), new Item(1618, Utils.random(17, 34)) }, new Item[] { new Item(1631, 1), new Item(1615, 1), new Item(9341, 40 + Utils.random(30)), new Item(9342, 57), new Item(15511, 1), new Item(15509, 1), new Item(15505, 1), new Item(15507, 1), new Item(15503, 1), new Item(11212, 40 + Utils.random(104)), new Item(9193, 62 + Utils.random(8)), new Item(11230, Utils.random(182, 319)), new Item(11232, 70), new Item(1306, Utils.random(1, 2)), new Item(1249, 1) }, new Item[] { new Item(9194, Utils.random(1, 71)) }, new Item[] { new Item(7158, 1), new Item(2366, 1), new Item(6571, 1) }),

		DRAGON_IMPLING(6054, 11256, 390, 553, 83, new Item[] { new Item(537, Utils.random(5, 9)), new Item(1616, Utils.random(1, 3)), new Item(5316), new Item(1215), new Item(11230, Utils.random(10, 30)) }, new Item[] { new Item(535, Utils.random(5, 15)), new Item(11212, Utils.random(3, 9)), new Item(11237, 15), new Item(9193, 5), new Item(9341, Utils.random(5, 30)), new Item(11232, 15), new Item(1305) }, new Item[] { new Item(1705, Utils.random(1, 2)), new Item(1703, Utils.random(1, 3)), new Item(4093), new Item(7219, Utils.random(1, 5)), new Item(5300, Utils.random(1, 3)) }, new Item[] { new Item(5547) }),

		RUBY_HARVEST(5085, 10020, 12, 24, 15, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }),

		SAPPHIRE_GLACIALIS(5084, 10018, 17, 34, 25, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }),

		SNOWY_KNIGHT(5083, 10016, 22, 44, 35, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }),

		BLACK_WARLOCK(5082, 10014, 27, 54, 45, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }, new Item[] { new Item(-1) }),;
