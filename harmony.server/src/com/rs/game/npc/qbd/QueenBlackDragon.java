...
public final class QueenBlackDragon extends NPC {
	...
	public void openRewardChest(boolean replace) {
		/*if (attacker.gotqbdpet != true) {
			hasgotqbdpet = Utils.random(1499);
			switch (hasgotqbdpet) {
			case 0:
				World.sendWorldMessage(
						"<img=7><col=ff8c38>News: " + attacker.getDisplayName() + " has receiveda Queen Black Dragon pet",
						false);
				attacker.gotqbdpet = true;
				attacker.sendMessage(
						"<col=330000>Congratulations! Please visit the Pet Tamer at home to get your pet.</col>");
				break;
			default:
				break;
			}
