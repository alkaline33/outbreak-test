...
import com.rs.game.npc.Drop1;
import com.rs.game.npc.Drops;

public class NPCDrops1 {

    private final static String PACKED_PATH = "data/npcs/packedDrops1.d";
	...
	try {
		...
		List<Drop1>[] dList = new ArrayList[Drops.VERY_RARE + 1];
		...
		for (int i = 0; i < size; i++) {
			...
			continue;
		    Drop1 drop = new Drop1(itemId, min, max);
		    if (dList[rarity] == null)
			dList[rarity] = new ArrayList<Drop1>();
